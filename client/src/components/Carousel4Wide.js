            ...
            <div className="container text-center my-3">
                <div className="row mx-auto my-auto justify-content-center">
                    <div id="bookCarousel" className="carousel slide" data-bs-ride="carousel">
                            ...
                            <div className="carousel-item active">
                                <div className="col-md-3">
                                    <div className="card carouselCard">
                                        ...
                                        <div className="card-img-overlay"><a className="clubName" href='clubs/1' >The Bookworms</a></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a className="carousel-control-prev bg-transparent w-aut" href="#bookCarousel" role="button" data-bs-slide="prev">
                            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                        </a>
                        <a className="carousel-control-next bg-transparent w-aut" href="#bookCarousel" role="button" data-bs-slide="next">
