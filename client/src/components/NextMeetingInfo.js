          ...
          <div className="col-md-8 my-auto">
            {props.currentClub && props.clubBooks.length ? (
              <div className="card-body ms-3 ">
                ...
                <h5><b>Time:</b> {props.currentClub.next_mtg_time.slice(0, 5)}</h5>
                <h5><b>Location:</b> {props.currentClub.next_mtg_location_name}</h5>
                <h5><b>
                  Address:</b> {props.currentClub.next_mtg_address},{" "}
